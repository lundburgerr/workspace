...
%---------------------------------------------------------
\title{Measurement of Heat Expansion 
by an Interferometer.}
\author{Robin Lundberg (rolu0008@student.umu.se) \\ 
				Tobias Dahlberg (toda0006@gmail.com)} 
...
\bibitem{coff} Thermal expansion coefficient, \url{http://en.m.wikipedia.org/wiki/Thermal_expansion_coefficients_of_the_elements_(data_page)}, (\today).
\end{thebibliography}
