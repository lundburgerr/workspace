function [myfit, h] = velfind(laser1, laser2, fs, func, startpoint)
...
%Fit data to model
myfit = fit(time, Enorm, func, 'StartPoint', startpoint);
...
%legend('Measured energy', sprintf('4/(%ft+%f)^2', myfit.a, myfit.b));
legend('Measured energy', sprintf('tan^2(-%f(t+%f))', myfit.b, myfit.c));
