...
#pragma  DATA_SECTION (plot13, "extvar")
#pragma  DATA_SECTION (plot14, "extvar")
...
#pragma  DATA_ALIGN(plot13, 64)
#pragma  DATA_ALIGN(plot14, 64)
...
void plot_init() {
	...
	memset(plot13.psData, 0, TV_PLOT_LENGTH*sizeof(short));
	memset(plot14.psData, 0, TV_PLOT_LENGTH*sizeof(short));
